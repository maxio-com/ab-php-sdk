...
{
    /**
     * Creates a Product Price Point. See the [Product Price Point](https://maxio.zendesk.com/hc/en-
     * us/articles/24261111947789-Product-Price-Points) documentation for details.
     *
     ...
     *
     * @param int|string $productId The id or handle of the product. When using the handle, it must
     *        be prefixed with `handle:`. Example: `123` for an integer ID, or `handle:example-
     ...
     *        example-product-price-point-handle` for a string handle.
     ...
     *        site level, you can pass ?currency_prices=true to include an array of currency price
     *        data in the response. If the product price point is set to use_site_exchange_rate:
     *        true, it will return pricing based on the current exchange rate. If the flag is set
