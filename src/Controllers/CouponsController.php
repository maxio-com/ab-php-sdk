...
class CouponsController extends BaseController
{
     ...
     * the default product family in your site, you need to specify (either in the URL or as a query string
     * param) the `product_family_id`.
     *
     ...
     * exchange rate. If the flag is set to false, it returns all of the defined prices for each currency.
     *
     * @param int $productFamilyId The Advanced Billing id of the product family to which the coupon
     *        belongs
     ...
     * that are entered by a customer.
     *
     * If you have more than one product family and if the coupon you are validating does not belong to the
     * first product family in your site, you need to specify the product family, either in the URL or as a
     * query string param. This can be done by supplying the id or the handle in the `handle:my-family`
     * format.
     *
     ...
     * spaces. Lowercase letters are capitalized before the subcode is created.
     *
     ...
     *
     * For more information on coupon codes and applying coupons to subscriptions, see [Coupon Codes](https:
     * //maxio.zendesk.com/hc/en-us/articles/24261208729229-Coupon-Codes) and [Coupons and
