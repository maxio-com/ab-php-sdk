...
/**
 * Builder for model Invoice1
 *
 * @see Invoice1
 */
class Invoice1Builder
{
    /**
     * @var Invoice1
     */
    ...
    private function __construct(Invoice1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new invoice 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new Invoice1());
    }
    ...
    /**
     * Initializes a new invoice 1 object.
     */
    public function build(): Invoice1
    {
