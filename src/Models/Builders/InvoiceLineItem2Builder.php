...
use AdvancedBillingLib\Models\InvoiceLineItem2;
use AdvancedBillingLib\Models\InvoiceLineItemComponentCostData;
use Core\Utils\CoreHelper;

/**
 * Builder for model InvoiceLineItem2
 *
 * @see InvoiceLineItem2
 */
class InvoiceLineItem2Builder
{
    /**
     * @var InvoiceLineItem2
     */
    private $instance;

    private function __construct(InvoiceLineItem2 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new invoice line item 2 Builder object.
     */
    public static function init(): self
    {
        return new self(new InvoiceLineItem2());
    }
    ...
    /**
     * Initializes a new invoice line item 2 object.
     */
    public function build(): InvoiceLineItem2
    {
