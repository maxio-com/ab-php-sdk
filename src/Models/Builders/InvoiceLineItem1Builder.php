...
use AdvancedBillingLib\Models\InvoiceLineItem1;
use Core\Utils\CoreHelper;

/**
 * Builder for model InvoiceLineItem1
 *
 * @see InvoiceLineItem1
 */
class InvoiceLineItem1Builder
{
    /**
     * @var InvoiceLineItem1
     */
    private $instance;

    private function __construct(InvoiceLineItem1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new invoice line item 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new InvoiceLineItem1());
    }
     ...
     */
    public function componentCostData(?ComponentCostData1 $value): self
    {
    ...
    /**
     * Initializes a new invoice line item 1 object.
     */
    public function build(): InvoiceLineItem1
    {
