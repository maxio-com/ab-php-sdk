...
/**
 * Builder for model ProformaInvoicePreview
 *
 * @see ProformaInvoicePreview
 */
class ProformaInvoicePreviewBuilder
{
    /**
     * @var ProformaInvoicePreview
     */
    private $instance;

    private function __construct(ProformaInvoicePreview $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new proforma invoice preview Builder object.
     */
    public static function init(): self
    {
        return new self(new ProformaInvoicePreview());
    }
    ...
    /**
     * Initializes a new proforma invoice preview object.
     */
    public function build(): ProformaInvoicePreview
    {
