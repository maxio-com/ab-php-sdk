...
/**
 * Builder for model SubscriptionBankAccount
 *
 * @see SubscriptionBankAccount
 */
class SubscriptionBankAccountBuilder
{
    /**
     * @var SubscriptionBankAccount
     */
    private $instance;

    private function __construct(SubscriptionBankAccount $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new subscription bank account Builder object.
     */
    public static function init(): self
    {
        return new self(new SubscriptionBankAccount());
    }
    ...
    /**
     * Initializes a new subscription bank account object.
     */
    public function build(): SubscriptionBankAccount
    {
