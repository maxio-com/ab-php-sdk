...
/**
 * Builder for model CurrencyOveragePrices
 *
 * @see CurrencyOveragePrices
 */
class CurrencyOveragePricesBuilder
{
    /**
     * @var CurrencyOveragePrices
     */
    private $instance;

    private function __construct(CurrencyOveragePrices $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Currency Overage Prices Builder object.
     */
    public static function init(): self
    {
        return new self(new CurrencyOveragePrices());
    }
    ...
    /**
     * Sets currency overage prices field.
     *
     * @param ComponentCurrencyPrice[]|null $value
     */
    public function currencyOveragePrices(?array $value): self
    {
        $this->instance->setCurrencyOveragePrices($value);
        return $this;
    }
    ...
    /**
     * Initializes a new Currency Overage Prices object.
     */
    public function build(): CurrencyOveragePrices
    {
