...
/**
 * Builder for model UpdateInvoiceItem
 *
 * @see UpdateInvoiceItem
 */
class UpdateInvoiceItemBuilder
{
    /**
    ...
    private function __construct(UpdateInvoiceItem $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Update Invoice Item Builder object.
     */
    public static function init(): self
    {
        return new self(new UpdateInvoiceItem());
    }
    ...
    /**
     * Initializes a new Update Invoice Item object.
     */
    public function build(): UpdateInvoiceItem
    {
