...
/**
 * Builder for model ApplePayPaymentProfile
 *
 * @see ApplePayPaymentProfile
 */
class ApplePayPaymentProfileBuilder
{
    /**
     * @var ApplePayPaymentProfile
     */
    private $instance;

    private function __construct(ApplePayPaymentProfile $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new apple pay payment profile Builder object.
     */
    public static function init(string $paymentType): self
    {
        return new self(new ApplePayPaymentProfile($paymentType));
    }
    ...
    /**
     * Initializes a new apple pay payment profile object.
     */
    public function build(): ApplePayPaymentProfile
    {
