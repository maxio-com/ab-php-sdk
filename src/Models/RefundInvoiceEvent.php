...
class RefundInvoiceEvent implements \JsonSerializable
{
    /**
     * @var int
     */
     ...
     */
    public function getEventData(): RefundInvoiceEventData
    {
     ...
     * @maps event_data
     */
    public function setEventData(RefundInvoiceEventData $eventData): void
    {
        $this->eventData = $eventData;
    }

    /**
     * Converts the RefundInvoiceEvent object to a human-readable string representation.
     *
     * @return string The string representation of the RefundInvoiceEvent object.
     */
