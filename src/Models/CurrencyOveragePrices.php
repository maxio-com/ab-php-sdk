 ...
 */
class CurrencyOveragePrices implements \JsonSerializable
{
    /**
     * @var int|null
     */
    ...
    /**
     * Returns Currency Overage Prices.
     * Applicable only to prepaid usage components. An array of currency pricing data for overage prices.
     *
     * @return ComponentCurrencyPrice[]|null
     */
    public function getCurrencyOveragePrices(): ?array
    {
        return $this->currencyOveragePrices;
    }

    /**
     * Sets Currency Overage Prices.
     * Applicable only to prepaid usage components. An array of currency pricing data for overage prices.
     *
     * @maps currency_overage_prices
     *
     * @param ComponentCurrencyPrice[]|null $currencyOveragePrices
     */
    public function setCurrencyOveragePrices(?array $currencyOveragePrices): void
    {
        $this->currencyOveragePrices = $currencyOveragePrices;
    }

    /**
     * Converts the CurrencyOveragePrices object to a human-readable string representation.
     *
     * @return string The string representation of the CurrencyOveragePrices object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'currencyOveragePrices' => $this->currencyOveragePrices,
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->currencyOveragePrices)) {
            $json['currency_overage_prices']    = $this->currencyOveragePrices;
        }
