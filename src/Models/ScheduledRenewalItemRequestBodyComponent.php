...
class ScheduledRenewalItemRequestBodyComponent implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * @var ScheduledRenewalComponentCustomPrice|null
     */
    private $customPrice;
     ...
     */
    public function getCustomPrice(): ?ScheduledRenewalComponentCustomPrice
    {
     ...
     * @maps custom_price
     */
    public function setCustomPrice(?ScheduledRenewalComponentCustomPrice $customPrice): void
    {
        $this->customPrice = $customPrice;
    }

    /**
     * Converts the ScheduledRenewalItemRequestBodyComponent object to a human-readable string
     * representation.
     *
     * @return string The string representation of the ScheduledRenewalItemRequestBodyComponent object.
     */
