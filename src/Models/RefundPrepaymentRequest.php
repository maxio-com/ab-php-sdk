...
class RefundPrepaymentRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the RefundPrepaymentRequest object to a human-readable string representation.
     *
     * @return string The string representation of the RefundPrepaymentRequest object.
     */
