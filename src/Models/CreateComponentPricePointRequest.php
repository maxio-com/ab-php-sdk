...
class CreateComponentPricePointRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateComponentPricePointRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CreateComponentPricePointRequest object.
     */
