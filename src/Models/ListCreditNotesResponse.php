...
class ListCreditNotesResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListCreditNotesResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListCreditNotesResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'ListCreditNotesResponse',
            ['creditNotes' => $this->creditNotes, 'additionalProperties' => $this->additionalProperties]
        );
    }
