...
class SubscriptionNoteResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the SubscriptionNoteResponse object to a human-readable string representation.
     *
     * @return string The string representation of the SubscriptionNoteResponse object.
     */
