...
class CreatePaymentProfile implements \JsonSerializable
{
    ...
    /**
     * Converts the CreatePaymentProfile object to a human-readable string representation.
     *
     * @return string The string representation of the CreatePaymentProfile object.
     */
