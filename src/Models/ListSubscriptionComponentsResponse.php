...
class ListSubscriptionComponentsResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListSubscriptionComponentsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListSubscriptionComponentsResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                'subscriptionsComponents' => $this->subscriptionsComponents,
