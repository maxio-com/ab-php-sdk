...
class DeliverProformaInvoiceRequest implements \JsonSerializable
{
    /**
     * @var string[]|null
     */
    ...
    /**
     * Converts the DeliverProformaInvoiceRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeliverProformaInvoiceRequest object.
     */
