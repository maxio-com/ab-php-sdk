...
class CreateMetafield implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the CreateMetafield object to a human-readable string representation.
     *
     * @return string The string representation of the CreateMetafield object.
     */
