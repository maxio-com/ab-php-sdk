...
class RemovePaymentEvent implements \JsonSerializable
{
    /**
     * @var int
     */
     ...
     */
    public function getEventData(): RemovePaymentEventData
    {
     ...
     * @maps event_data
     */
    public function setEventData(RemovePaymentEventData $eventData): void
    {
        $this->eventData = $eventData;
    }

    /**
     * Converts the RemovePaymentEvent object to a human-readable string representation.
     *
     * @return string The string representation of the RemovePaymentEvent object.
     */
