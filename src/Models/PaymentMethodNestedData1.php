 ...
 *
 * @discriminator type
 * @discriminatorType Payment Method Nested Data1
 */
class PaymentMethodNestedData1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    {
        $json = [];
        $json['type']                  = $this->type ?? 'Payment Method Nested Data1';
