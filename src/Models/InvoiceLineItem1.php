...
class InvoiceLineItem1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function getComponentCostData(): ?ComponentCostData1
    {
     ...
     */
    public function setComponentCostData(?ComponentCostData1 $componentCostData): void
    {
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->componentCostData)) {
            $json['component_cost_data']    = $this->componentCostData;
        }
