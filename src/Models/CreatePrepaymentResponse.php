...
class CreatePrepaymentResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CreatePrepaymentResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CreatePrepaymentResponse object.
     */
