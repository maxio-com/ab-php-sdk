...
class CreatedPaymentProfile implements \JsonSerializable
{
    /**
     * @var int|null
     */
    ...
    {
        if (count($this->maskedCardNumber) == 0) {
            return null;
        }
        return $this->maskedCardNumber['value'];
    }
    ...
    {
        $this->maskedCardNumber['value'] = $maskedCardNumber;
    }

    /**
     * Unsets Masked Card Number.
     */
    public function unsetMaskedCardNumber(): void
    {
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->maskedCardNumber)) {
            $json['masked_card_number']         = $this->maskedCardNumber['value'];
        }
