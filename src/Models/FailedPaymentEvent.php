...
class FailedPaymentEvent implements \JsonSerializable
{
    /**
     * @var int
     */
     ...
     */
    public function getEventData(): FailedPaymentEventData
    {
     ...
     * @maps event_data
     */
    public function setEventData(FailedPaymentEventData $eventData): void
    {
        $this->eventData = $eventData;
    }

    /**
     * Converts the FailedPaymentEvent object to a human-readable string representation.
     *
     * @return string The string representation of the FailedPaymentEvent object.
     */
