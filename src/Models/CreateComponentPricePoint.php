...
class CreateComponentPricePoint implements \JsonSerializable
{
     ...
     * multiple currencies defined on the site. Setting not supported when creating price points in bulk.
     */
     ...
     * Whether or not the price point includes tax. Setting not supported when creating price points in
     * bulk.
     */
