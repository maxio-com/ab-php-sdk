...
/**
 * A line item change for a draft ad hoc invoice. Supports the same attributes as line items on invoice
 * creation, plus `uid` and `_destroy` for updating or removing existing line items.
 */
class UpdateInvoiceItem implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Returns Uid.
     * Unique identifier of an existing line item on the invoice. When provided, the matching line item is
     * updated with the submitted attributes. When omitted, a new line item is added to the invoice.
     */
    ...
    /**
     * Converts the UpdateInvoiceItem object to a human-readable string representation.
     *
     * @return string The string representation of the UpdateInvoiceItem object.
     */
