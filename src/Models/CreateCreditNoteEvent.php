...
class CreateCreditNoteEvent implements \JsonSerializable
{
    /**
     * @var int
     */
     ...
     */
    public function getEventData(): CreditNote
    {
     ...
     * @maps event_data
     */
    public function setEventData(CreditNote $eventData): void
    {
        $this->eventData = $eventData;
    }

    /**
     * Converts the CreateCreditNoteEvent object to a human-readable string representation.
     *
     * @return string The string representation of the CreateCreditNoteEvent object.
     */
