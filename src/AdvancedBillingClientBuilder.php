...
class AdvancedBillingClientBuilder
{
    ...
    public function basicAuthCredentials(BasicAuthCredentialsBuilder $basicAuthBuilder): self
    {
        $this->config = array_merge($this->config, $basicAuthBuilder->getConfiguration());
        return $this;
    }
