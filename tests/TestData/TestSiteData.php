...
{
    public const SITE_ID = 4676;
    public const SITE_NAME = 'PHP SDK Env';
    public const SITE_SUBDOMAIN = 'php-sdk';
    public const SITE_CURRENCY = 'USD';
    public const SELLER_ID = 722159;
    public const EMPTY_NON_PRIMARY_CURRENCIES_LIST = [];
    ...
    public const ORGANIZATION_ADDRESS_NAME = 'Developer Experience';
