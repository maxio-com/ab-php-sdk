...
| `expirationIntervalUnit` | string([ExtendedIntervalUnit](../../doc/models/extended-interval-unit.md))\|null | Optional | This is a container for one-of cases. | getExpirationIntervalUnit(): ?string | setExpirationIntervalUnit(?string expirationIntervalUnit): void |
