...
| `reasonCode` | `?string` | Optional | The churn reason code associated to a canceled subscription. | getReasonCode(): ?string | setReasonCode(?string reasonCode): void |
...
$subscription = SubscriptionBuilder::init()
    ...
    ->creditCard(
        CreditCardPaymentProfileBuilder::init(
