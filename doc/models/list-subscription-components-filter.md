...
```php
use AdvancedBillingLib\Models\Builders\ListSubscriptionComponentsFilterBuilder;

$listSubscriptionComponentsFilter = ListSubscriptionComponentsFilterBuilder::init()
    ->currencies(
        [
            'EUR',
            'USD'
