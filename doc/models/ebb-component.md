...
|  --- | --- | --- | --- | --- | --- |
| `name` | `string` | Required | A name for this component that is suitable for showing customers and displaying on billing statements, i.e., "Minutes". | getName(): string | setName(string name): void |
...
$eBBComponent = EBBComponentBuilder::init(
    'name0',
    'unit_name2',
