...
| `snapDay` | string\|int\|null | Optional | This is a container for one-of cases. | getSnapDay(): | setSnapDay( snapDay): void |
...
$updateSubscription = UpdateSubscriptionBuilder::init()
    ...
    ->productHandle('product_handle0')
    ->productId(16)
    ->productChangeDelayed(false)
    ->nextProductId('next_product_id0')
    ->deferSignup(false)
