...
| `unitName` | `string` | Required | “The name of the unit of measurement for the component. It should be singular since it will be automatically pluralized when necessary. e.g., “message”, which may then be shown as “5 messages” on a subscription’s component line-item.” | getUnitName(): string | setUnitName(string unitName): void |
...
$quantityBasedComponent = QuantityBasedComponentBuilder::init(
    'name0',
    'unit_name2',
