...
```php
function applyCouponToSubscription(
    int $subscriptionId,
    ?string $code = null,
...
$result = $subscriptionsController->applyCouponToSubscription(
    $subscriptionId,
    null,
    $body
);
...
```php
function createPrepaidSubscription(
    int $subscriptionId,
...
$result = $subscriptionsController->createPrepaidSubscription(
    $subscriptionId,
    $body
);
```
