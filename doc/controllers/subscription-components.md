...
$collect = [
    ...
    'filter' => ListSubscriptionComponentsFilterBuilder::init()
        ->currencies(
            [
                'EUR',
                'USD'
...
$body = ActivateEventBasedComponentBuilder::init()
    ->pricePointId(1)
    ->billingSchedule(
...
$collect = [
    ...
    'perPage' => 50,
    'sort' => ListSubscriptionComponentsSort::UPDATED_AT,
    'filter' => ListSubscriptionComponentsForSiteFilterBuilder::init()
        ->currencies(
            [
                'EUR',
                'USD'
